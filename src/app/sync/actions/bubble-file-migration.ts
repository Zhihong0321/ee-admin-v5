...
const FILE_FIELDS_CONFIG = [
  { table: sedaRegistration, tableName: 'seda_registration', idField: 'id', dateField: 'created_date', fields: [
    ...
    { name: 'tnb_bills_12_months', type: 'array' as const, subfolder: 'seda/tnb_bills' },
    ...
    { name: 'ssm_form_9', type: 'single' as const, subfolder: 'seda/company_docs' },
    { name: 'ssm_form_49', type: 'single' as const, subfolder: 'seda/company_docs' },
    { name: 'director_ic_front', type: 'single' as const, subfolder: 'seda/company_docs' },
    { name: 'director_ic_back', type: 'single' as const, subfolder: 'seda/company_docs' },
