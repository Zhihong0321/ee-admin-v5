...
export const invoices = pgTable('invoice', {
  ...
  paid_amount: numeric('paid_amount').default('0'), // Sum of verified payments linked to this invoice
...
export const sedaRegistration = pgTable('seda_registration', {
  ...
  tnb_bills_12_months: text('tnb_bills_12_months').array(),
  tnb_bills_12_months_requested_at: timestamp('tnb_bills_12_months_requested_at', { withTimezone: true }),
  tnb_bills_12_months_note: text('tnb_bills_12_months_note'),
  ...
  ssm_form_9: text('ssm_form_9'),
  ssm_form_49: text('ssm_form_49'),
  director_ic_front: text('director_ic_front'),
  director_ic_back: text('director_ic_back'),
  commercial_docs_completed: boolean('commercial_docs_completed'),
